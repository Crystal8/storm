...
public class WordCountTopology {
    ...
    public static void main(String[] args) throws AlreadyAliveException, InvalidTopologyException {
        ...
        //将2改为1会发现计数结果将近少了一半
        //这边需要改成1，如果是2的话，将会有两个executor占有输入文件，导致不能重命名文件
        ...
        if(args.length==0) {
            ...
            config.put("input_file_dir", "E:\\storm\\wordcount\\input");
            config.put("output_file", "E:\\storm\\wordcount\\output\\count.out");
            ...
            try {
                config.put("input_file_dir", args[1]);
                config.put("output_file", args[2]);
